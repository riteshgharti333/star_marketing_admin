...
const UpdateService = ({ isDarkMode = false }) => {
  ...
  useEffect(() => {
    const fetchServiceData = async () => {
      try {
        ...
        const singleData = data?.service;

        if (data && data.success) {
          setFormData({
            bannerSection: {
              bannerImage: singleData.bannerSection?.bannerImage || "",
              bannerTitle: singleData.bannerSection?.bannerTitle || "",
              bannerDesc: singleData.bannerSection?.bannerDesc || "",
              serviceName: singleData.bannerSection?.serviceName || "",
            },
            selectedService: singleData.selectedService || "",
            strategy: {
              title: singleData.strategy?.title || "",
              desc: singleData.strategy?.desc || "",
              items: singleData.strategy?.items || [{ title: "", desc: "" }],
            },
            howItWorks: {
              title: singleData.howItWorks?.title || "",
              desc: singleData.howItWorks?.desc || "",
              items: singleData.howItWorks?.items || [
                { title: "", desc: "" },
                { title: "", desc: "" },
              ],
            },
            ...
            contentSection: {
              ...
              desc: singleData.contentSection?.desc || "",
            },
          });
        }
      } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Append all images that are File objects
      if (formData.bannerSection.bannerImage instanceof File) {
        formDataToSend.append(
          "bannerImage",
          formData.bannerSection.bannerImage
        );
      } else if (typeof formData.bannerSection.bannerImage === "string") {
        formDataToSend.append(
          "bannerImage",
          formData.bannerSection.bannerImage
        );
      ...
      } else if (typeof formData.contentSection.image === "string") {
        formDataToSend.append(
          "contentSectionImage",
          formData.contentSection.image
        );
                    ...
                    <div className="flex items-center justify-center space-x-4">
                      {formData.bannerSection.bannerImage ? (
                        <div className="relative group ">
                          <img
                            src={
                              formData.bannerSection.bannerImage instanceof File
                                ? URL.createObjectURL(
                                    formData.bannerSection.bannerImage
                                  )
                                : formData.bannerSection.bannerImage
                    ...
                    <div className="flex items-center justify-center space-x-4">
                      {formData.contentSection.image ? (
                        <div className="relative group">
                          <img
                            src={
                              formData.contentSection.image instanceof File
                                ? URL.createObjectURL(
                                    formData.contentSection.image
                                  )
                                : formData.contentSection.image
